						...
						<table>
							<form action="" method="post">
								...
								<tr>
									<td>Nama Depan</td>
									<td> : </td>
									<td><input type="text" name="depan" class="form-control"></td>
								</tr>
								<tr>
									<td>Nama Belakang</td>
									<td> : </td>
								...
								<tr>
									...
									<td>
										...
										<input type="checkbox" name="genre[]" value="Action">Acton<br>
								...
								<tr>
									...
									<td>
										...
										<input type="checkbox" name="wisata[]" value="Lombok">Tanjung Selor<br>
										<input type="checkbox" name="wisata[]" value="Bromo">Jakarta<br>
								...
								<tr>
									<td><input type="submit" name="inputdata" value="Input Data" class=""></td>
								</tr>
							</form>
						</table>
